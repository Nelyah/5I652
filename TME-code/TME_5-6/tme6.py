...
class CirclesData:
    ...
    def plot_data(self):
        ...
        plt.plot(self._Xtrain[self._Ytrain[:,0] == 1,0], self._Xtrain[self._Ytrain[:,0] == 1,1], 'b.', label="Train")
        plt.plot(self._Xtrain[self._Ytrain[:,1] == 1,0], self._Xtrain[self._Ytrain[:,1] == 1,1], 'r.')
    ...
    def plot_pred(self, pred):
        ...
        print(pred)
        plt.figure(1, figsize=(5,5))
        plt.plot(self._Xtrain[pred == 1,0], self._Xtrain[pred == 1,1], 'b.', label="Train")
        plt.plot(self._Xtrain[pred == 1,0], self._Xtrain[pred == 1,1], 'r.')
        plt.plot(self._Xtest[self._Ytest[:,0] == 1,0], self._Xtest[self._Ytest[:,0] == 1,1], 'b+', label="Test")
        plt.plot(self._Xtest[self._Ytest[:,1] == 1,0], self._Xtest[self._Ytest[:,1] == 1,1], 'r+')
        plt.legend()
        plt.savefig('circles_pred.png')
        plt.savefig('circles_pred.pdf')
    ...
    def plot_data_with_grid(self, Ygrid, title=""):
        ...
        plt.plot(self._Xtrain[self._Ytrain[:,0] == 1,0]*10+20, self._Xtrain[self._Ytrain[:,0] == 1,1]*10+20, 'b.', label="Train")
        plt.plot(self._Xtrain[self._Ytrain[:,1] == 1,0]*10+20, self._Xtrain[self._Ytrain[:,1] == 1,1]*10+20, 'r.')
...
class MNISTData:
    ...
    def plot_loss(self, loss_train, loss_test, acc_train, acc_test):
        ...
        plt.savefig('mnist_acc_loss.pdf')
